...
export default function PWAWidget() {
  return (
    <section className="w-full mt-[219px] mb-24 flex justify-center font-poppins">
      <div className="w-full h-[320px] md:h-[400px] lg:h-[449px] xl:h-[484px] bg-[#2E9DA7] relative overflow-visible z-10">
        ...
        <div className="absolute left-[37px] top-[38px] xl:left-[141px] text-white z-10 flex flex-col items-start gap-2.5 sm:gap-4 md:gap-5 max-w-[calc(100%-140px)] lg:max-w-[636px] add-home-screen-content-wrapper">
          <h2 className="add-home-screen-title sm:text-[32px] lg:text-[54px] lg:leading-[64px] font-medium text-[#FCFAF9] tracking-tight">
            Add Bookly to your <br /> home screen
          </h2>

          {/* Subtitle tick frame */}
          <div className="flex items-center gap-1.5 sm:gap-2">
            <span className="add-home-screen-subtitle sm:text-base md:text-[18px] md:leading-[26px] font-medium text-[#FCFAF9]">
        ...
        <div className="absolute left-[120px] xl:left-[256px] top-[215px] xl:top-[245px] w-[36px] xl:w-[114px] h-[40px] xl:h-[151px] pointer-events-none opacity-95 z-20 add-home-screen-arrow-icon">
          <Image src="/Icons/direction.png" alt="Direction Arrow" className="w-full h-full object-contain" draggable="false" fill sizes="(max-width: 768px) 36px, 114px" />
        </div>
