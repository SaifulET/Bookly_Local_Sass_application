...
interface SearchSuggestionsDropdownProps {
  ...
  setDropdownFilter: (f: string) => void;
  dropdownWidth: number | null;
  activeSegment: "search" | "location" | "time" | null;
  setActiveSegment: (seg: "search" | "location" | "time" | null) => void;
  setShowSearchDropdown: (show: boolean) => void;
  setShowTimePicker: (show: boolean) => void;
  currentLocationActive: boolean;
  setCurrentLocationActive: (active: boolean) => void;
...
export default function SearchSuggestionsDropdown({
  ...
  // Mobile Calendar/Time picker state
  const [selectedDate, setSelectedDate] = useState<Date>(new Date(2026, 7, 17));
    ...
    <>
      ...
      <div className="md:hidden fixed inset-0 bg-white z-[300] flex flex-col p-5 animate-in fade-in slide-in-from-bottom duration-300 font-poppins">
        ...
        {activeSegment === "location" ? (
          <div className="flex-1 flex flex-col gap-[40px] overflow-y-auto text-left px-1">
            ...
            <div className="flex flex-row justify-between items-center w-full h-10 shrink-0 border-b border-neutral-100 pb-4">
              <span className="font-medium text-[18px] leading-[26px] text-[#111111] select-none">Current Location</span>
              <button
                type="button"
                onClick={() => {
              ...
              {[
                ...
                >
                  <div className="flex flex-row items-center gap-[16px] w-full h-[30px]">
                    <HugeiconsIcon icon={Location05Icon} className="text-[#0C0C0C] w-6 h-6 shrink-0" />
                    <span className="font-medium text-[18px] leading-[30px] text-[#111111] group-hover:text-neutral-600 transition-colors">
                      {loc}
                    </span>
                  </div>
                  {index < arr.length - 1 && (
          ...
          <div className="flex-1 flex flex-col gap-6 overflow-y-auto text-left pb-10">
            <div className="flex flex-row justify-between items-center w-full py-1 shrink-0">
              <div className="flex items-center gap-1 cursor-pointer">
                <span className="font-medium text-sm text-[#111111]">{months[currentMonth]} {currentYear}</span>
            ...
            <div className="w-full pt-0 pr-3 pb-3 pl-6 border-b border-[#CAC4D0] shrink-0">
              <h3 className="font-normal text-[32px] leading-10 text-[#111111] text-left">
            ...
            <div className="grid grid-cols-7 w-full text-center px-3 shrink-0">
              {["S", "M", "T", "W", "T", "F", "S"].map((d, index) => (
                <span key={index} className="font-normal text-base leading-6 text-[#111111] py-2">{d}</span>
              ))}
            </div>
                ...
                cells.push(
                  <div key={`day-${day}`} className="h-10 flex items-center justify-center">
                    <button
                      ...
                      className={`w-10 h-10 flex items-center justify-center rounded-full text-base transition-colors ${isSelected
            ...
            <div className="flex flex-col items-start gap-4 w-full mt-6 pt-4 border-t border-neutral-100 shrink-0">
              <span className="font-bold text-sm text-[#111111]">Select time</span>
            ...
            {selectedTimeOption === "Custom" && (
              <div className="w-full mt-4 flex flex-col gap-4 shrink-0">
                <h4 className="font-bold text-sm text-[#111111]">Custom Time</h4>
          ...
          <div className="flex-1 flex flex-col gap-6 overflow-y-auto px-1 text-left">
            <div className="flex flex-col gap-2 w-full pb-3 border-b border-neutral-100">
              <span className="font-medium text-xs tracking-wider text-neutral-400 uppercase">Filters</span>
            ...
            <div className="flex flex-col gap-4 w-full">
              <span className="font-medium text-xs tracking-wider text-neutral-400 uppercase">Trending searches</span>
              <div className="flex flex-wrap gap-1.5">
        ...
        <div className="w-full pt-4 mt-auto border-t border-neutral-100 shrink-0">
          <button
            ...
            className="w-full py-3.5 bg-[#1C1B1C] hover:bg-black text-white rounded-full font-semibold text-sm flex items-center justify-center gap-2"
          >
            <span>Search</span>
