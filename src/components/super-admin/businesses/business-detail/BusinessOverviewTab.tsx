    ...
    <div className="flex flex-col gap-6 w-full text-gray-900">
      ...
      <div className="bg-white rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.08)] border border-gray-100 overflow-hidden flex flex-col">
        <button
          ...
          className="px-6 py-4 flex justify-between items-center w-full bg-white hover:bg-gray-55 cursor-pointer border-none"
        >
        ...
        <div className="px-6 py-4 flex justify-between items-center w-full bg-white border-b border-gray-100">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-1 hover:bg-gray-55 rounded cursor-pointer bg-transparent border-none"
            >
              <HugeiconsIcon
                icon={ArrowDown01Icon}
        ...
        <div className="bg-white rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.08)] border border-gray-100 p-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex py-3 text-sm">
              ...
              <span className="text-[#111827] font-medium">20% commission commission clause acknowledged</span>
            </div>
          </div>
        </div>
      </div>
