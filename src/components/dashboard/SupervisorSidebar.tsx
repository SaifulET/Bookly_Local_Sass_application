...
export default function SupervisorSidebar({
  ...
  return (
    <aside className={`bg-[#C0D5D8] flex flex-col justify-between shrink-0 border-r border-[#B0C5C8] h-full transition-all duration-300 ${isCollapsed ? "w-[78px]" : "w-[280px]"}`}>
      ...
      {/* Sidebar Header with Supervisor badge */}
          ...
          <>
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[10px] text-[#111111]/60 font-poppins mt-1">Supervisor</span>
              </div>
            </div>
            <button
      ...
      {/* Sidebar Navigation - removed business profile, services, addons, payouts & finance, analytics */}
      <div className={`flex-1 overflow-y-auto p-4 space-y-6 select-none ${isCollapsed ? "px-2" : ""} scrollbar-hide`}>
        ...
        {/* SUPERVISOR VIEWABLE BUSINESS SECTION */}
        <div className="space-y-1">
          {!isCollapsed && (
